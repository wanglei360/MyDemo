...
import com.fragment.wanglei.myapplication.GlobalParams;
...
public class LogUtils {
     ...
     * 日志输出时的TAG
     */
    private static String mTag = UIUtils.getContext().getPackageName();
    /**
     * 是否允许输出log
     */
    private static int mDebuggable = GlobalParams.Debuggable;
