...
import com.my.socket.processor.RssProcessor;
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == RssProcessor.ID) {
				if (msg.arg1 == ServiceProcessor.RETURN_MESSAGE_OK) {
					...
					Log.i("An error has occured.", (String) msg.getData().getSerializable(ServiceProcessor.BUNDLE_EXTRA_MESSAGE_THROWABLE));
				}
			}
		}
	}
