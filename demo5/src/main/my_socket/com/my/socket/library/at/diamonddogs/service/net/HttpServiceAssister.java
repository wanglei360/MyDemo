 ...
 */
package com.my.socket.library.at.diamonddogs.service.net;
...
import com.my.socket.library.at.diamonddogs.net.WebClient;
import com.my.socket.library.at.diamonddogs.nontimecritical.NonTimeCriticalTaskManager;
...
import com.my.socket.library.at.diamonddogs.data.dataobjects.NonTimeCriticalTaskQueueDefaultConfiguration;
import com.my.socket.library.at.diamonddogs.exception.ServiceException;
...
import com.my.socket.library.at.diamonddogs.nontimecritical.NonTimeCriticalTaskQueueConfigurationDefaultFactory;
import com.my.socket.library.at.diamonddogs.service.processor.ServiceProcessor;
import com.my.socket.library.at.diamonddogs.service.processor.SynchronousProcessor;
import com.my.socket.library.at.diamonddogs.util.AndroidUtils;
...
public class HttpServiceAssister {
     ...
     */
    public void runWebRequest(Handler.Callback callback, WebRequest webRequest, ServiceProcessor<?> serviceProcessor,
                              WebClient.DownloadProgressListener progressListener) {
     ...
     * {@link HttpService#runSynchronousWebRequest(WebRequest, WebClient.DownloadProgressListener)}
     ...
     */
    public HttpService.WebRequestReturnContainer runSynchronousWebRequest(WebRequest webRequest, ServiceProcessor<?> serviceProcessor) {
     ...
     * and
     * {@link HttpServiceAssister#runSynchronousWebRequest(WebRequest, ServiceProcessor, WebClient.DownloadProgressListener)}
     ...
     */
    private void addWebRequestToQueue(Handler handler, WebRequest webRequest, WebClient.DownloadProgressListener progressListener,
    ...
    public class HttpServiceAssisterConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            httpService = ((HttpService.HttpServiceBinder) service).getHttpService();
            synchronized (monitor) {
                monitor.notify();
            }
    ...
    private static final class WebRequestInformation {
        ...
        private WebClient.DownloadProgressListener progressListener;

        public WebRequestInformation(Handler handler, WebRequest webRequest, WebClient.DownloadProgressListener progressListener,
                                     ServiceProcessor<?> serviceProcessor) {
