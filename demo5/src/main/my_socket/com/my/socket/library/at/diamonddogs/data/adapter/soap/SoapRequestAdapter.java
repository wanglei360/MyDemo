 ...
 */
package com.my.socket.library.at.diamonddogs.data.adapter.soap;
...
import com.my.socket.library.at.diamonddogs.data.dataobjects.SoapRequest;
...
public class SoapRequestAdapter {
    ...
    private void initRequest(String soapAction, SoapSerializationEnvelope envelope) {
        ...
        request.setRequestType(WebRequest.Type.POST);
