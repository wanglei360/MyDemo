 ...
 */
package com.my.socket.library.at.diamonddogs.service.importservice;
...
public abstract class OrderedImportServiceContract<T extends Serializable> extends ImportServiceContract<T> {
	...
	/**
	 * Gets the import {@link HttpOrderedAsyncAssister.HttpOrderedAsyncRequest}
	 * 
	 * @param i
	 *            the intent used to start the service
	 * @return a {@link HttpOrderedAsyncAssister.HttpOrderedAsyncRequest}
	 */
	protected abstract HttpOrderedAsyncAssister.HttpOrderedAsyncRequest getOrderedAsyncWebRequest(Intent i);
}
