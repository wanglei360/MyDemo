...
public class ImageProcessor extends DataProcessor<Bitmap, Bitmap> {
     ...
     * @param object the {@link CacheManager.CachedObject} obtained from the cache database
     * @return returns the {@link Bitmap}, either from file or from memory cache
     * or <code>null</code> if something goes awefully wrong
     */
    @Override
    public Bitmap obtainDataObjectFromCachedObject(Context c, WebRequest wr, CacheManager.CachedObject object) {
    ...
    @Override
    public void processCachedObject(CacheManager.CachedObject cachedObject, Handler handler, Request request) {
