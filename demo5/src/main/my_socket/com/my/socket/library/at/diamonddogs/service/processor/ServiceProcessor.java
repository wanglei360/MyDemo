...
import com.my.socket.library.at.diamonddogs.data.adapter.parcelable.ParcelableAdapterWebReply;
import com.my.socket.library.at.diamonddogs.data.adapter.parcelable.ParcelableAdapterWebRequest;
import com.my.socket.library.at.diamonddogs.data.dataobjects.Reply;
...
import com.my.socket.library.at.diamonddogs.util.Utils;
import com.my.socket.library.at.diamonddogs.data.dataobjects.CacheInformation;
...
public abstract class ServiceProcessor<OUTPUT> {
	...
	/**
	 * Called if there is a {@link CacheManager.CachedObject} available for the
	 * {@link Request} that is being processed
	 * 
	 * @param cachedObject
	 *            the {@link CacheManager.CachedObject} related to the {@link Request}
	 * @param handler
	 *            the {@link Handler} instance that posts the result of the
	 *            {@link Request} to the UI thread
	 * @param request
	 ...
	 */
	public abstract void processCachedObject(CacheManager.CachedObject cachedObject, Handler handler, Request request);
	 ...
	 */
	public void processCachedObject(CacheManager.CachedObject cachedObject, Handler handler, Request request, Context context) {
