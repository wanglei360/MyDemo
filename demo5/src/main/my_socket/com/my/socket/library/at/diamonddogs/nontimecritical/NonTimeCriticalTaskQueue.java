 ...
 */
package com.my.socket.library.at.diamonddogs.nontimecritical;
...
public class NonTimeCriticalTaskQueue {
	 ...
	 */
	protected void removeNonTimeCriticalTasksByPriority(NonTimeCriticalTask.PRIORITY priority) {
		synchronized (tasks) {
	 ...
	 * s according to their {@link NonTimeCriticalTask.PRIORITY}
	 */
