...
public class ParcelableAdapterWebRequest extends ParcelableAdapter<WebRequest> {
	...
	public ParcelableAdapterWebRequest(Parcel in) {
		...
		dataObject.setRequestType((WebRequest.Type) in.readSerializable());
	 ...
	 * Required by Parcelable mechanism
	 */
	public static final Creator<ParcelableAdapterWebRequest> CREATOR = new Creator<ParcelableAdapterWebRequest>() {
		@Override
