 ...
 */
package com.my.socket.library.at.diamonddogs.data.adapter.parcelable;

import android.os.Parcel;

import com.my.socket.library.at.diamonddogs.data.dataobjects.TempFile;
...
public class ParcelableAdapterTempFile extends ParcelableAdapter<TempFile> {
	 ...
	 * Required by Parcelable mechanism
	 */
	public static final Creator<ParcelableAdapterTempFile> CREATOR = new Creator<ParcelableAdapterTempFile>() {
