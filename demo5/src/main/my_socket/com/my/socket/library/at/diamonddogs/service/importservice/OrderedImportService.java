...
/**
 * This import service supports the execution of {@link HttpOrderedAsyncAssister.HttpOrderedAsyncRequest}
 * s.
 * 
 * @param <T>
...
public abstract class OrderedImportService<T extends Serializable> extends Service implements ImportService<T> {
	...
	/**
	 * The assister used to run the {@link HttpOrderedAsyncAssister.HttpOrderedAsyncRequest}s
	 */
