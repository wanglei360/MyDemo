...
public abstract class SosUniversalAdapter extends BaseAdapter implements SectionIndexer, OnScrollListener {
	...
	public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
		if (view instanceof com.telephone_book.widget.SosUniversalListView) {
			((com.telephone_book.widget.SosUniversalListView) view).configureHeaderView(firstVisibleItem);
		}
	}
