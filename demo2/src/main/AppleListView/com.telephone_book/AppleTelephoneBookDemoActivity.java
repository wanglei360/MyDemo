package com.telephone_book;

import java.util.List;

import com.telephone_book.widget.SosUniversalAdapter;
import com.telephone_book.widget.SosUniversalListView;
 ...
 *
 */
public class AppleTelephoneBookDemoActivity extends Activity {
	SosUniversalListView lsComposer;  //Diy ListView
	SectionComposerAdapter adapter;   //适配器

	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.apple_telephone_book);

		lsComposer = (SosUniversalListView) findViewById(R.id.lsComposer);
		lsComposer.setPinnedHeaderView(LayoutInflater.from(this).inflate(R.layout.apple_telephone_book_item_composer_header, lsComposer, false));
	...
	class SectionComposerAdapter extends SosUniversalAdapter {
		...
		public View getAmazingView(int position, View convertView, ViewGroup parent) {
			...
			if (res == null) res = getLayoutInflater().inflate(R.layout.apple_telephone_book_item_composer, null);
