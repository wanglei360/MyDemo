 ...
 * <p>修改备注：
 */
public class ListRecyclerViewActivity extends Activity implements SimpleListAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.list_recycler_view_native_layout);

        recyclerView = (RecyclerView) findViewById(R.id.list_recycler_view_native);
    ...
    public void recyclerViewselection(View view){
        llManager.scrollToPositionWithOffset(50,0);
        adapter.notifyDataSetChanged();
    }

    @Override
    public void onItemClickListener(View view, int positon) {
        Toast.makeText(this, view != null ? String.valueOf(view.getTag()) : "", Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "我是position " + String.valueOf(positon), Toast.LENGTH_SHORT).show();
    }
