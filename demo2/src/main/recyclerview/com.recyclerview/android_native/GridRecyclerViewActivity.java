...
public class GridRecyclerViewActivity extends Activity {
    ...
    private GridLayoutManager llManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.grid_recycler_view_native_layout);
        recycler_view = (RecyclerView) findViewById(R.id.grid_recycler_view_native);
         ...
         * @param int spanCount gridView的列的数量
         */
        llManager = new GridLayoutManager(this, 5);
        init(state);
    }
    ...
    private void init(int state) {
        ...
        recycler_view.setAdapter(new SimpleListAdapter(imageArray, this, state));
    }
