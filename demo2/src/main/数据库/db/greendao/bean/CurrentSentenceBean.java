...
public class CurrentSentenceBean implements Serializable {
    ...
    public CurrentSentenceBean(Long ID, long userId, long classID, long taskID, long partID, long sentenceID, long type, String text, String textColor, String netAddress, String myAddress, String chishengNetAddress, long myVoiceTime, long myNum, boolean state) {
        this.ID = ID;
        this.userId = userId;
